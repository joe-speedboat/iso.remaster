...
RC=0
test -f $BASE_DIR/inject/ks-custom_rhel10.cfg || ( echo "error kickstart not found" ; exit 1 )
test -f $BASE_DIR/inject/ks_efi-custom_rhel10.cfg || ( echo "error kickstart not found" ; exit 1 )

cp -a $BASE_DIR/inject/ks-custom_rhel10.cfg $BASE_DIR/inject/ks-custom_rhel10.cfg.orig
cp -a $BASE_DIR/inject/ks_efi-custom_rhel10.cfg $BASE_DIR/inject/ks_efi-custom_rhel10.cfg.orig
...
echo "--- $BASE_DIR/inject/ks-custom_rhel10.cfg*"
diff $BASE_DIR/inject/ks-custom_rhel10.cfg*
echo "--- $BASE_DIR/inject/ks_efi-custom_rhel10.cfg*"
diff $BASE_DIR/inject/ks_efi-custom_rhel10.cfg*
