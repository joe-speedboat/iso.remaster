...
cp -a $BASE_DIR/inject/ks-custom_rhel9.cfg $BASE_DIR/inject/ks-custom_rhel9.cfg.orig
cp -a $BASE_DIR/inject/ks_efi-custom_rhel9.cfg $BASE_DIR/inject/ks_efi-custom_rhel9.cfg.orig
...
echo "--- $BASE_DIR/inject/ks-custom_rhel9.cfg*"
diff $BASE_DIR/inject/ks-custom_rhel9.cfg*
echo "--- $BASE_DIR/inject/ks_efi-custom_rhel9.cfg*"
diff $BASE_DIR/inject/ks_efi-custom_rhel9.cfg*
